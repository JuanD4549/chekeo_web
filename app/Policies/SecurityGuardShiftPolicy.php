...
class SecurityGuardShiftPolicy
{
     ...
     */
    public function view(User $user, SecurityGuardShift $securityGuardShift): bool
    {
     ...
     */
    public function update(User $user, SecurityGuardShift $securityGuardShift): bool
    {
     ...
     */
    public function delete(User $user, SecurityGuardShift $securityGuardShift): bool
    {
     ...
     */
    public function forceDelete(User $user, SecurityGuardShift $securityGuardShift): bool
    {
     ...
     */
    public function restore(User $user, SecurityGuardShift $securityGuardShift): bool
    {
     ...
     */
    public function replicate(User $user, SecurityGuardShift $securityGuardShift): bool
    {
